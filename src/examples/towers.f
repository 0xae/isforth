...
\ were made to this code by me but i added some isforth hooks to the
...
\ ------------------------------------------------------------------------
\ not defined in the isforth kernel so added here
...
\ isforth doesnt have arrays - use create

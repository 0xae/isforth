\ case.f        - an example of how to use case: statements in isforth
\ ------------------------------------------------------------------------
...
\ thus far where isforth enforces good programming practices.
\
\ case
...
\ uncomment the aove 4 lines then have isforth interpret this file. it
\ will save out an executable called foo that you can run on any x86
\ based linux box even if isforth isnt installed there.

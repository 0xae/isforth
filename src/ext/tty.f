\ tty.f     - isforth terminal initialization
\ ------------------------------------------------------------------------
...
m: termget       ( --- )  intios $5401 0 <ioctl> drop ;m
m: termset       ( --- )  intios $5402 0 <ioctl> drop ;m
...
: init-term     ( --- )
  ...
  defers default ;         \ link into hi priority default chain
